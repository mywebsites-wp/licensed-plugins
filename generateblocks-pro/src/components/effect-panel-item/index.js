								...
								<div className="gblocks-advanced-dropdown-options">
									{ 'transforms' === effectType &&
										<div className="gblocks-transform-type">
											<SelectControl
												...
												options={ [
													{ label: __( 'Choose..', 'generateblocks' ), value: '' },
													{ label: __( 'Translate', 'generateblocks' ), value: 'translate' },
													{ label: __( 'Rotate', 'generateblocks' ), value: 'rotate' },
													{ label: __( 'Skew', 'generateblocks' ), value: 'skew' },
													{ label: __( 'Scale', 'generateblocks' ), value: 'scale' },
												] }
												onChange={ ( value ) => {
													const effectValues = [ ...effects ];
									...
									{ 'filters' === effectType &&
										<div className="gblocks-transform-type">
											<SelectControl
												...
												options={ [
													{ label: __( 'Choose..', 'generateblocks' ), value: '' },
													{ label: __( 'Blur', 'generateblocks' ), value: 'blur' },
													{ label: __( 'Brightness', 'generateblocks' ), value: 'brightness' },
													{ label: __( 'Contrast', 'generateblocks' ), value: 'contrast' },
													{ label: __( 'Grayscale', 'generateblocks' ), value: 'grayscale' },
													{ label: __( 'Hue-Rotate', 'generateblocks' ), value: 'hue-rotate' },
													{ label: __( 'Invert', 'generateblocks' ), value: 'invert' },
													{ label: __( 'Saturate', 'generateblocks' ), value: 'saturate' },
													{ label: __( 'Sepia', 'generateblocks' ), value: 'sepia' },
												] }
												onChange={ ( value ) => {
													const effectValues = [ ...effects ];
									...
									<div className="gblocks-advanced-dropdown-option-device">
										<SelectControl
											...
											options={ [
												{ label: __( 'All', 'generateblocks' ), value: 'all' },
												{ label: __( 'Desktop', 'generateblocks' ), value: 'desktop' },
												{ label: __( 'Tablet', 'generateblocks' ), value: 'tablet-only' },
												{ label: __( 'Tablet + Mobile', 'generateblocks' ), value: 'tablet' },
												{ label: __( 'Mobile', 'generateblocks' ), value: 'mobile' },
											] }
											onChange={ ( value ) => {
												const effectValues = [ ...effects ];
									...
									<div className="gblocks-advanced-dropdown-option-state">
										<SelectControl
											...
											options={ [
												{ label: __( 'Normal', 'generateblocks' ), value: 'normal' },
												{ label: __( 'Hover', 'generateblocks' ), value: 'hover' },
											] }
											onChange={ ( value ) => {
												const effectValues = [ ...effects ];
										...
										<Fragment>
											...
											<div className="gblocks-adv-dropdown-option">
												<SelectControl
													...
													options={ [
														{ label: __( 'Choose…', 'generateblocks' ), value: '' },
														{ label: __( 'Multiply', 'generateblocks' ), value: 'multiply' },
														{ label: __( 'Screen', 'generateblocks' ), value: 'screen' },
														{ label: __( 'Overlay', 'generateblocks' ), value: 'overlay' },
														{ label: __( 'Darken', 'generateblocks' ), value: 'darken' },
														{ label: __( 'Lighten', 'generateblocks' ), value: 'lighten' },
														{ label: __( 'Color Dodge', 'generateblocks' ), value: 'color-dodge' },
														{ label: __( 'Color Burn', 'generateblocks' ), value: 'color-burn' },
														{ label: __( 'Hard Light', 'generateblocks' ), value: 'hard-light' },
														{ label: __( 'Soft Light', 'generateblocks' ), value: 'soft-light' },
														{ label: __( 'Difference', 'generateblocks' ), value: 'difference' },
														{ label: __( 'Exclusion', 'generateblocks' ), value: 'exclusion' },
														{ label: __( 'Hue', 'generateblocks' ), value: 'hue' },
														{ label: __( 'Saturation', 'generateblocks' ), value: 'saturation' },
														{ label: __( 'Color', 'generateblocks' ), value: 'color' },
														{ label: __( 'Luminosity', 'generateblocks' ), value: 'luminosity' },
													] }
													onChange={ ( value ) => {
														const effectValues = [ ...effects ];
									...
									{ 'transition' === effectType &&
										<Fragment>
											...
											<div className="gblocks-adv-dropdown-option">
												<TextControl
													label={ __( 'CSS Property', 'generateblocks' ) }
													type={ 'text' }
										...
										<Fragment>
											...
											{ 'rotate' === effects[ index ].type &&
												<Fragment>
													<div className="gblocks-adv-dropdown-option">
														<UnitPicker
															label={ __( 'Rotate', 'generateblocks' ) }
															value={ 'deg' }
															units={ [ 'deg' ] }
															onClick={ () => {
																return false;
											...
											{ 'skew' === effects[ index ].type &&
												<Fragment>
													<div className="gblocks-adv-dropdown-option">
														<UnitPicker
															label={ __( 'Skew X', 'generateblocks' ) }
															value={ 'deg' }
															units={ [ 'deg' ] }
															onClick={ () => {
																return false;
										...
										<Fragment>
											...
											{ 'brightness' === effects[ index ].type &&
												<Fragment>
													<div className="gblocks-adv-dropdown-option">
														<UnitPicker
															label={ __( 'Brightness', 'generateblocks' ) }
															value={ '%' }
															units={ [ '%' ] }
															onClick={ () => {
																return false;
											...
											{ 'contrast' === effects[ index ].type &&
												<Fragment>
													<div className="gblocks-adv-dropdown-option">
														<UnitPicker
															label={ __( 'Contrast', 'generateblocks' ) }
															value={ '%' }
															units={ [ '%' ] }
															onClick={ () => {
																return false;
											...
											{ 'grayscale' === effects[ index ].type &&
												<Fragment>
													<div className="gblocks-adv-dropdown-option">
														<UnitPicker
															label={ __( 'Grayscale', 'generateblocks' ) }
															value={ '%' }
															units={ [ '%' ] }
															onClick={ () => {
																return false;
											...
											{ 'hue-rotate' === effects[ index ].type &&
												<Fragment>
													<div className="gblocks-adv-dropdown-option">
														<UnitPicker
															label={ __( 'Hue-Rotate', 'generateblocks' ) }
															value={ 'deg' }
															units={ [ 'deg' ] }
															onClick={ () => {
																return false;
											...
											{ 'invert' === effects[ index ].type &&
												<Fragment>
													<div className="gblocks-adv-dropdown-option">
														<UnitPicker
															label={ __( 'Invert', 'generateblocks' ) }
															value={ '%' }
															units={ [ '%' ] }
															onClick={ () => {
																return false;
											...
											{ 'saturate' === effects[ index ].type &&
												<Fragment>
													<div className="gblocks-adv-dropdown-option">
														<UnitPicker
															label={ __( 'Saturate', 'generateblocks' ) }
															value={ '%' }
															units={ [ '%' ] }
															onClick={ () => {
																return false;
