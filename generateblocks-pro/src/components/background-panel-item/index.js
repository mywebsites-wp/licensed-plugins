										...
										{ ! advBackgrounds[ index ].type &&
											<SelectControl
												...
												options={ [
													...
													{ label: __( 'Image', 'generateblocks' ), value: 'image' },
													{ label: __( 'Gradient', 'generateblocks' ), value: 'gradient' },
												] }
												onChange={ ( value ) => {
												...
												<div className="gblocks-adv-dropdown-option gblocks-adv-dropdown-option-no-grow">
													...
													>
														<ColorPicker
															...
															alpha={ true }
															valueOpacity={ advBackgrounds[ index ].colorOneOpacity }
															onChange={ ( value ) => {
																const effectValues = [ ...advBackgrounds ];
												...
												<div className="gblocks-adv-dropdown-option gblocks-adv-dropdown-option-no-grow">
													...
													>
														<ColorPicker
															...
															alpha={ true }
															valueOpacity={ advBackgrounds[ index ].colorTwoOpacity }
															onChange={ ( value ) => {
																const effectValues = [ ...advBackgrounds ];
