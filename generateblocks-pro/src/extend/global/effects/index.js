...
function addControls( output, data ) {
	...
	return (
		<Fragment>
			<Fragment>
				<PanelBody
					title={ __( 'Effects', 'generateblocks' ) }
					initialOpen={ false }
						...
						<ToggleControl
							label={
								opacities.length > 0 && !! useOpacity ? (
									...
									sprintf( __( 'Opacity & Blend (%s)', 'generateblocks' ), opacities.length )
								) : (
						...
						<Dropdown
							...
							renderToggle={ ( { isOpen, onToggle } ) => (
								<Button
									...
									icon={ isOpen ? 'no-alt' : 'admin-tools' }
									onClick={ onToggle }
									...
									<Fragment>
										...
										<div className="gblocks-advanced-dropdown-actions">
											...
											<ToggleControl
												...
												label={ __( 'Disable in editor', 'generateblocks' ) }
						...
						<ToggleControl
							label={
								transitions.length > 0 && !! useTransition ? (
									/* translators: Number of transforms. */
									sprintf( __( 'Transition (%s)', 'generateblocks' ), transitions.length )
								) : (
						...
						<ToggleControl
							label={
								boxShadows.length > 0 && !! useBoxShadow ? (
									/* translators: Number of transforms. */
									sprintf( __( 'Box Shadow (%s)', 'generateblocks' ), boxShadows.length )
								) : (
						...
						<ToggleControl
							label={
								textShadows.length > 0 && !! useTextShadow ? (
									/* translators: Number of transforms. */
									sprintf( __( 'Text Shadow (%s)', 'generateblocks' ), textShadows.length )
								) : (
						...
						<ToggleControl
							label={
								transforms.length > 0 && !! useTransform ? (
									/* translators: Number of transforms. */
									sprintf( __( 'Transform (%s)', 'generateblocks' ), transforms.length )
								) : (
						...
						<ToggleControl
							label={
								filters.length > 0 && !! useFilter ? (
									/* translators: Number of transforms. */
									sprintf( __( 'Filter (%s)', 'generateblocks' ), filters.length )
								) : (
