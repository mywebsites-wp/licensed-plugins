		...
		apiFetch( {
			...
			if ( ! result.success || ! result.response ) {
				...
				if ( 'valid' === result.response.license ) {
					message.textContent = __( 'License key activated.', 'generateblocks' );
				} else if ( 'deactivated' === result.response.license ) {
					message.textContent = __( 'License key deactivated.', 'generateblocks' );
				} else {
					message.textContent = result.response;
				}
								...
								<PanelRow>
									<BaseControl>
										<ToggleControl
											...
											help={ __( 'Get alpha and beta updates directly to your Dashboard.', 'generateblocks' ) }
