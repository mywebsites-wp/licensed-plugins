													...
													>
														...
														<Button
															...
															onClick={ () => {
																...
																if ( window.confirm( __( 'This will permanently delete all icons in this group.', 'generateblocks' ) ) ) {
																	const assetValues = [ ...this.state.icons ];
														...
														{ this.state.icons[ index ].icons.length > 0 &&
															<Button
																...
																{ this.state.icons[ index ].icons && this.state.icons[ index ].icons.map( ( icon, iconIndex ) => {
																	return <Fragment key={ iconIndex }>
																		<div className="gblocks-asset-item">
																			...
																			<Tooltip text={ __( 'Delete Icon', 'generateblocks' ) }>
																				<Button
																					className="gblocks-delete-asset"
																					onClick={ () => {
																						// eslint-disable-next-line
																						if ( window.confirm( __( 'This will permanently delete this icon.', 'generateblocks' ) ) ) {
																							const assetValues = [ ...this.state.icons ];
