						...
						<div className="gblocks-dashboard-panel-row-wrapper">
							<PanelRow>
								...
								>
									...
									{ ! generateBlocksProSettings.hasSafeSVG &&
										<Notice
											className="gblocks-assets-safe-svg-notice"
											isDismissible={ false }
											status={ 'warning' }
											actions={ [ {
												label: __( 'Install Safe SVG', 'generateblocks-pro' ),
												isLink: true,
												url: generateBlocksProSettings.safeSVGInstallLink,
											} ] }
										>
											{ __( 'The Safe SVG plugin is recommended to improve the functionality of this feature.', 'generateblocks-pro' ) }
										</Notice>
									}
													...
													>
														...
														<Button
															...
															onClick={ () => {
																...
																if ( window.confirm( __( 'This will permanently delete all shapes in this group and remove them from the front-end of your website.', 'generateblocks' ) ) ) {
																	const assetValues = [ ...this.state.shapes ];
														...
														{ this.state.shapes[ index ].shapes.length > 0 &&
															<Button
																		...
																		<div className="gblocks-asset-item">
																			...
																			<Tooltip text={ __( 'Delete Shape', 'generateblocks' ) }>
																				<Button
																					...
																					onClick={ () => {
																						// eslint-disable-next-line
																						if ( window.confirm( __( 'This will permanently delete this shape and remove it from the front-end of your website.', 'generateblocks' ) ) ) {
																							const assetValues = [ ...this.state.shapes ];
