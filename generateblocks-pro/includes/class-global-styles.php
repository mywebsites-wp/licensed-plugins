...
class GenerateBlocks_Pro_Global_Styles {
	...
	public function build_css( $post_id, $post ) {
		...
		$global_styles[ $post_id ]['ids'] = array();
		...
		foreach ( (array) $block_data as $name => $data ) {
			foreach ( $data as $attributes ) {
				...
				if ( ! isset( $global_styles[ $post_id ]['ids'][ $name ] ) ) {
					$global_styles[ $post_id ]['ids'][ $name ] = array();
				}

				if ( ! in_array( $attributes['uniqueId'], $global_styles[ $post_id ]['ids'][ $name ] ) ) {
					$global_styles[ $post_id ]['ids'][ $name ][] = $attributes['uniqueId'];
				}
